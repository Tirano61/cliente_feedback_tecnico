...
│       ├── domain/
│       │   ├── entities/caso.dart
│       │   └── repositories/i_caso_repository.dart
│       ├── application/
│       │   ├── cargar_caso_use_case.dart
│       │   └── obtener_mis_casos_use_case.dart
│       ├── infrastructure/
│       │   ├── dtos/caso_dto.dart
│       │   └── repositories/caso_repository_impl.dart
│       └── presentation/
│           ├── bloc/caso_bloc.dart
│           ├── bloc/caso_event.dart
│           ├── bloc/caso_state.dart
│           ├── pages/nuevo_caso_page.dart
│           ├── pages/mis_casos_page.dart
│           └── widgets/formulario_caso.dart
│
└── main.dart
```
        ...
        child: MaterialApp(
          ...
          home: BlocBuilder<AuthBloc, AuthState>(
            builder: (context, state) {
              ...
              if (state is AuthAuthenticated) return const NuevoCasoPage();
...
La validación ocurre en el BLoC al recibir `CasoGuardarPressed`, nunca en la vista.
