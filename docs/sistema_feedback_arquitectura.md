...
| Tabla | Campos clave |
|---|---|
| caso_servicio | id, tecnico_id, cliente_id, canal, fecha, equipo_nro_serie, equipo_modelo, equipo_ubicacion, equipo_anio, componente_fallo, sintoma, diagnostico_cat_id, diagnostico_detalle, resolucion_id, km, resuelto, observaciones |
